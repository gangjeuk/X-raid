...
def check_magic(data) -> bool:
    magic = b'EFI PART'
    # check magic values: EFI and BR
    ...
    for file_name in file_names:
        with open(file_name, 'rb') as f:
            for i in range(0x100):
                if check_magic(f.read(SECTOR_SIZE)):
                    print("Found Partition Record. First disk: {}, Offset: {}".format(file_name, hex(i * SECTOR_SIZE)))
